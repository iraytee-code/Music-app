...
const FavouriteCard = ({ imageName, songTitle, artisteName, duration }) => {
  return (
    <Fragment>
      <div className=" bg-[#1A1E1F] cursor-pointer  hover:bg-gradient-to-tr from-playlistBg to-yellow-500 text-dark  rounded-xl p-3 w-[300px] h-[233px] md:w-[100%] md:h-auto">
